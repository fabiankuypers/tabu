// Global language store using browser's localStorage
export type Language = 'de' | 'en';

class LanguageStore {
  private listeners: Set<(language: Language) => void> = new Set();
  private _language: Language = 'de';
  ...
  private init() {
    ...
    const saved = localStorage.getItem('tabu-language') as Language;
  ...
  setLanguage(lang: Language) {
    ...
    if (typeof window !== 'undefined') {
      localStorage.setItem('tabu-language', lang);
    }
